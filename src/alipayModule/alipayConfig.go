...
type Alipay_config_struct struct {
	//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
...
var Alipay_web_config = &Alipay_config_struct{
...
var Alipay_mobile_config = &Alipay_config_struct{
	Partner:   "2088501949844011",
	Key:       "viz4safb1zazb5bqeraujlg79agfcj02",
	Sign_type: "RSA",
	Private_key_path: []byte(`
...
var Alipay_wap_config = &Alipay_config_struct{
	Partner:   "2088501949844011",
	Key:       "viz4safb1zazb5bqeraujlg79agfcj02",
	Sign_type: "MD5",
	Private_key_path: []byte(`
...
func Init(alipay_config *Alipay_config_struct) error {
	//	log.I("init alipay_config : %v", alipay_config)
	log.I("init rsakeys begin")
	log.I("init PrivateKey ")
	block, _ := pem.Decode(alipay_config.Private_key_path)
	if block == nil {
		log.E("rsaSign private_key error")
		return fmt.Errorf("rsaSign pem.Decode error")
	}
	var err error
	alipay_config.Private_key, err = x509.ParsePKCS1PrivateKey(block.Bytes)
	if err != nil {
		log.E("rsaSign ParsePKIXPublicKey error : %v\n", err)
		return err
	}

	log.I("init PrivateKey ")
	block, _ = pem.Decode(alipay_config.Ali_public_key_path)
	if block == nil {
		log.E("public key error")
		return err
	}
	...
	alipay_config.Public_key = pubInterface.(*rsa.PublicKey)
	log.I("init rsakeys success ")
	return err
}

//func init() {
//	//	Init(Alipay_mobile_config)
//	Init(Alipay_wap_config)
//}
